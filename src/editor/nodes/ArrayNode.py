...
@register_node(name='Get (Array)',input={'array':VGDtypes.Array,'index':VGDtypes.Integer},output={'item':VGDtypes.Class},package='基础',is_pure=True)
def ArrayGet(array:VGDtypes.Array,index:VGDtypes.Integer):
    return array[index]

@register_node(name='Set (Array)',output={'array':VGDtypes.Array},package='基础')
def ArraySet(array:VGDtypes.Array,index:VGDtypes.Integer,value:VGDtypes.Class):
    array[index] = value
    return array

@register_node(name='Length (Array)',output={'length':VGDtypes.Integer},package='基础',is_pure=True)
