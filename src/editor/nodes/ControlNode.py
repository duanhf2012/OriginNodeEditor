...
class ForEachIntegerNode(Node):
    package_name = '流程控制'
    node_title = '数组遍历(整型)'
    node_description = '数组遍历(整型)'
    ...
    output_pins = [
        ...
        NodeOutput(pin_name='item',pin_class=VGDtypes.Integer,pin_type='data'),
...
class ForEachStringNode(Node):
    package_name = '流程控制'
    node_title = '数组遍历(字符串)'
    node_description = '数组遍历(字符串)'
    ...
    output_pins = [
        NodeOutput(pin_name='Loop Body',pin_type='exec'),
        NodeOutput(pin_name='index',pin_class=VGDtypes.Integer,pin_type='data'),
        NodeOutput(pin_name='item',pin_class=VGDtypes.String,pin_type='data'),
        NodeOutput(pin_name='Completed',pin_type='exec')
