...
import os
from widgets.PortWidget import StringArrayWdg, ReadFileWdg, WriteFileWdg, IntegerArrayWdg
...
class IntegerArray(Node):
    package_name = '输入节点'

    node_title = 'IntegerArray'
    node_description = '输入节点'
